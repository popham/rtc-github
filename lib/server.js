...
httpApp.get('/facebook', passport.authenticate('facebook'));

httpApp.get(
    '/facebook/callback',
    passport.authenticate('facebook', {
        failureRedirect : 'https://popham.github.io/rtc-github/example/messages/#loggedOut'
    }),
    function(request, response) {
        response.redirect('https://popham.github.io/rtc-github/example/messages/#loggedIn');
    }
);

// Redirect implies an extra round trip :(
httpApp.get('/google', passport.authenticate('google', {
